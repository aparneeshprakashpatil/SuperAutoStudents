...
class Main {
    ...
    public static ArrayList<SuperPets> enemyPets = new ArrayList<SuperPets>();
    public static ArrayList<SuperPets> fightingPets = new ArrayList<SuperPets>();

    public static void main(String args[]) {
        Scanner in = new Scanner(System.in);
        settingEmpty();
        System.out.println("Welcome to Super Auto Pets!");
    ...
    public static void confirm() {
        ...
        System.out.println("Would you like to keep it (y) or roll for a better one (n)? (You have " + stupidvalue
                + " rolls left.)");
